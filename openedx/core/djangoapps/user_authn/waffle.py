...
# Intended as a temporary toggle for roll-out of jwt sessions cookies feature.
JWT_SESSION_COOKIES_FLAG = WaffleFlag(_WAFFLE_FLAG_NAMESPACE, u'jwt_session_cookies')
